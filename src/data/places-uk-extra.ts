...
export const placesUKExtra: Place[] = [
  ...
  place('manchester-bakery-4', 'manchester', 'bakery', 'Holy Grain Sourdough Bakery', 4.9, 'Arch 122 Woollam Pl, Manchester M3 4JJ, UK', '사워도우 전문 소규모 베이커리.', 'Small bakery specializing in sourdough.', { reviewCount: 103 }),
  ...
  // —— liverpool ——
  place('liverpool-fine_dining-1', 'liverpool', 'fine_dining', 'Daise By Tony Parkin', 4.8, '11 Rose Mount, Oxton, Birkenhead, Prenton CH43 5SG, UK', '옥스턴의 테이스팅 메뉴 파인 다이닝, 옛 Restaurant Fraiche 자리.', 'Tasting-menu fine dining in Oxton, on the former Restaurant Fraiche site.', { reviewCount: 92 }),
