...
export const placesHRExtra: Place[] = [
  ...
  place('dubrovnik-bakery-2', 'dubrovnik', 'bakery', 'Holy Burek', 4.5, 'Ul. od Puča 22, 20000 Dubrovnik', '구시가 푸차 거리의 부렉 전문점, 다양한 속재료로 인기.', 'Burek specialist on Puča street in the Old Town, popular for its variety of fillings.', { reviewCount: 1308 }),
  place('dubrovnik-bakery-3', 'dubrovnik', 'bakery', 'Pekarnica Pile', 4.4, 'Ul. branitelja Dubrovnika 3, 20000 Dubrovnik', '필레 성문 인근의 베이커리, 부렉과 페이스트리로 인기.', 'Bakery near the Pile Gate, popular for burek and pastries.', { reviewCount: 157 }),
  ...
  place('split-bakery-2', 'split', 'bakery', "BUTTER'S", 4.9, 'Ul. Matice hrvatske 12, 21000 Split', '스플리트의 인기 베이커리, 버터 향 가득한 페이스트리로 유명.', "Popular Split bakery known for its buttery pastries.", { reviewCount: 350 }),
  place('split-bakery-3', 'split', 'bakery', 'Oš Kolač - Artisan Cakes and Pastries', 4.8, 'Ćirila i Metoda 4, 21000 Split', '스플리트의 아르티장 케이크·페이스트리 전문점.', 'Artisan cake and pastry shop in Split.', { reviewCount: 1258 }),
  place('split-bakery-4', 'split', 'bakery', 'ST Burek', 4.5, 'Domaldova ul. 13, 21000 Split', '스플리트 구시가의 인기 부렉 전문점.', "Popular burek specialist in Split's Old Town.", { reviewCount: 1144 }),
  place('split-bakery-5', 'split', 'bakery', 'Cookie Lab', 4.8, 'Put Firula 1, 21000 Split', '스플리트의 인기 쿠키 전문점.', 'Popular cookie shop in Split.', { reviewCount: 879 }),
  ...
  place('zadar-bakery-2', 'zadar', 'bakery', 'Bakery Caffe Dalmatinka', 4.9, 'Poljana Pape Aleksandra III 6, 23000 Zadar', '자다르의 베이커리 카페.', 'Bakery café in Zadar.', { reviewCount: 61 }),
  place('zadar-bakery-3', 'zadar', 'bakery', 'Pekarnica Pletenica', 4.3, 'Ul. Vlatka Mačeka 6, 23000 Zadar', '자다르의 인기 베이커리.', 'Popular bakery in Zadar.', { reviewCount: 427 }),
  place('zadar-bakery-4', 'zadar', 'bakery', 'Pekara Zara', 4.5, 'Put Bokanjca 64, 23000 Zadar', '자다르 인근의 베이커리.', 'Bakery near Zadar.', { reviewCount: 251 }),
  ...
  place('rovinj-bakery-2', 'rovinj', 'bakery', 'Figment Artisan Bakery', 5.0, 'Ul. Marka Marulića 30, 52210 Rovinj', '로빈지의 아르티장 베이커리, 수제 빵과 페이스트리로 인기.', 'Artisan bakery in Rovinj, popular for handmade bread and pastries.', { reviewCount: 69 }),
  place('rovinj-bakery-3', 'rovinj', 'bakery', 'Slasticarna-Pasticceria Breski', 4.8, 'Ul. Ricarda Daveggie 3, 52210 Rovinj', '로빈지의 인기 제과점, 케이크와 디저트로 유명.', 'Popular pastry shop in Rovinj, known for its cakes and desserts.', { reviewCount: 132 }),
  place('rovinj-bakery-4', 'rovinj', 'bakery', 'Pekara dan i noc', 4.4, 'Ul. Giosue Carduccia 7, 52210 Rovinj', '24시간 영업하는 로빈지의 베이커리.', '24-hour bakery in Rovinj.', { reviewCount: 736 }),
  place('rovinj-bakery-5', 'rovinj', 'bakery', 'Tiramisù mio', 5.0, 'Ul. Grisia 2, 52210 Rovinj', '구시가 그리시아 거리의 티라미수 전문점.', 'Tiramisu specialty shop on Grisia street in the Old Town.', { reviewCount: 617 }),
  ...
  place('rovinj-cafe-2', 'rovinj', 'cafe', 'TUNI GALLERY - specialty coffee shop', 5.0, 'Ul. Joakima Rakovca 46, 52210 Rovinj', '로빈지의 스페셜티 커피숍, 갤러리 콘셉트의 인테리어.', 'Specialty coffee shop in Rovinj with a gallery-style interior.', { reviewCount: 252 }),
  place('rovinj-cafe-3', 'rovinj', 'cafe', 'Caffe Bar Chocolato', 4.7, 'Fontica 3, 52210 Rovinj', '폰티카 거리의 인기 카페 바.', 'Popular café bar on Fontica street.', { reviewCount: 365 }),
  place('rovinj-cafe-4', 'rovinj', 'cafe', 'Cinema', 4.6, 'Trg brodogradilišta, 52210 Rovinj', '조선소 광장에 위치한 인기 카페.', 'Popular café on Shipyard Square (Trg brodogradilišta).', { reviewCount: 1187 }),
  place('rovinj-cafe-5', 'rovinj', 'cafe', 'Viecia Batana cafe', 4.6, 'Trg Maršala Tita, 52210 Rovinj', '티토 광장의 인기 카페, 전통 바타나 보트를 테마로 함.', 'Popular café on Tito Square, themed around the traditional batana boat.', { reviewCount: 499 }),
  ...
  place('hvar-bakery-2', 'hvar', 'bakery', 'Pastry Shop Sweets', 4.8, 'Janka Zazjala 33, 21450 Hvar', '흐바르 구시가의 케이크 전문점, 수제 케이크와 타르트로 인기.', 'Cake shop in Hvar Old Town, popular for its handmade cakes and tarts.', { reviewCount: 180 }),
  ...
  place('hvar-cafe-2', 'hvar', 'cafe', 'kava37', 4.9, 'Kroz Burak 37, 21450 Hvar', '흐바르 구시가의 스페셜티 커피숍, 자가 로스팅 원두 사용.', 'Specialty coffee shop in Hvar Old Town using its own roasted beans.', { reviewCount: 882 }),
  place('hvar-cafe-3', 'hvar', 'cafe', 'Coffee Snob - Specialty Coffee', 4.6, 'Dr. Mate Miličića 13, 21450 Hvar', '흐바르의 스페셜티 커피 전문점.', 'Specialty coffee shop in Hvar.', { reviewCount: 620 }),
  place('hvar-cafe-4', 'hvar', 'cafe', 'Oasis Specialty Coffee and Juice Bar', 4.5, 'Trg svetog Stjepana 18, 21450 Hvar', '스테판 광장에 위치한 스페셜티 커피·주스 바.', "Specialty coffee and juice bar on St. Stephen's Square.", { reviewCount: 239 }),
  place('hvar-cafe-5', 'hvar', 'cafe', 'Caffe Bar Domenika', 4.9, 'Trg svetog Stjepana 25, 21450 Hvar', '스테판 광장의 아늑한 카페 바.', "Cozy café bar on St. Stephen's Square.", { reviewCount: 48 }),
]
