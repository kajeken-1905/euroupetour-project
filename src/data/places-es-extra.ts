...
export const placesESExtra: Place[] = [
  ...
  place('barcelona-bakery-2', 'barcelona', 'bakery', 'Hofmann', 4.6, 'Carrer dels Flassaders 44, 08003 Barcelona, Spain', '마스카포네 크루아상으로 유명한 보른 지구의 전설적인 파티스리', 'Legendary Born-district patisserie famous for its mascarpone-filled croissant', { reviewCount: 2100, image: '/places/barcelona-bakery-2.jpg' }),
