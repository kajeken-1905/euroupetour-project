...
export const placesESExtra: Place[] = [
  ...
  place('zaragoza-fine_dining-2', 'zaragoza', 'fine_dining', 'Zaragoza Fine Dining 2', 4.4, 'Zaragoza', '모던 로컬 다이닝.', 'Modern local dining.', { reviewCount: 520 }),
  place('zaragoza-fine_dining-3', 'zaragoza', 'fine_dining', 'Zaragoza Fine Dining 3', 4.3, 'Zaragoza', '클래식 다이닝.', 'Classic dining.', { reviewCount: 480 }),
  place('zaragoza-fine_dining-4', 'zaragoza', 'fine_dining', 'Zaragoza Bistro', 4.3, 'Zaragoza', '캐주얼 파인 비스트로.', 'Casual fine bistro.', { reviewCount: 700 }),
  place('zaragoza-fine_dining-5', 'zaragoza', 'fine_dining', 'Zaragoza Chef\'s Table', 4.4, 'Zaragoza', '셰프 테이블.', 'Chef’s table.', { reviewCount: 390 }),
  place('zaragoza-bakery-1', 'zaragoza', 'bakery', 'Zaragoza Bakery', 4.5, 'Zaragoza', '빵·페이스트리.', 'Bread and pastries.', { reviewCount: 900 }),
  place('zaragoza-bakery-2', 'zaragoza', 'bakery', 'Zaragoza Patisserie', 4.4, 'Zaragoza', '페이스트리 숍.', 'Pastry shop.', { reviewCount: 720 }),
  place('zaragoza-bakery-3', 'zaragoza', 'bakery', 'Zaragoza Bread House', 4.3, 'Zaragoza', '로컬 빵집.', 'Local bakery.', { reviewCount: 580 }),
  place('zaragoza-bakery-4', 'zaragoza', 'bakery', 'Café Bakery Zaragoza', 4.3, 'Zaragoza', '베이커리 카페.', 'Bakery café.', { reviewCount: 640 }),
  place('zaragoza-cafe-1', 'zaragoza', 'cafe', 'Specialty Coffee Zaragoza', 4.5, 'Zaragoza', '스페셜티 커피.', 'Specialty coffee.', { reviewCount: 1100 }),
  ...
  place('salamanca-fine_dining-2', 'salamanca', 'fine_dining', 'Salamanca Fine Dining 2', 4.4, 'Salamanca', '모던 로컬 다이닝.', 'Modern local dining.', { reviewCount: 520 }),
  place('salamanca-fine_dining-3', 'salamanca', 'fine_dining', 'Salamanca Fine Dining 3', 4.3, 'Salamanca', '클래식 다이닝.', 'Classic dining.', { reviewCount: 480 }),
  place('salamanca-fine_dining-4', 'salamanca', 'fine_dining', 'Salamanca Bistro', 4.3, 'Salamanca', '캐주얼 파인 비스트로.', 'Casual fine bistro.', { reviewCount: 700 }),
  place('salamanca-fine_dining-5', 'salamanca', 'fine_dining', 'Salamanca Chef\'s Table', 4.4, 'Salamanca', '셰프 테이블.', 'Chef’s table.', { reviewCount: 390 }),
  place('salamanca-bakery-1', 'salamanca', 'bakery', 'Salamanca Bakery', 4.5, 'Salamanca', '빵·페이스트리.', 'Bread and pastries.', { reviewCount: 900 }),
  place('salamanca-bakery-2', 'salamanca', 'bakery', 'Salamanca Patisserie', 4.4, 'Salamanca', '페이스트리 숍.', 'Pastry shop.', { reviewCount: 720 }),
  place('salamanca-bakery-3', 'salamanca', 'bakery', 'Salamanca Bread House', 4.3, 'Salamanca', '로컬 빵집.', 'Local bakery.', { reviewCount: 580 }),
  place('salamanca-bakery-4', 'salamanca', 'bakery', 'Café Bakery Salamanca', 4.3, 'Salamanca', '베이커리 카페.', 'Bakery café.', { reviewCount: 640 }),
  place('salamanca-cafe-1', 'salamanca', 'cafe', 'Specialty Coffee Salamanca', 4.5, 'Salamanca', '스페셜티 커피.', 'Specialty coffee.', { reviewCount: 1100 }),
  ...
  place('santiago-fine_dining-2', 'santiago', 'fine_dining', 'Santiago de Compostela Fine Dining 2', 4.4, 'Santiago de Compostela', '모던 로컬 다이닝.', 'Modern local dining.', { reviewCount: 520 }),
  place('santiago-fine_dining-3', 'santiago', 'fine_dining', 'Santiago de Compostela Fine Dining 3', 4.3, 'Santiago de Compostela', '클래식 다이닝.', 'Classic dining.', { reviewCount: 480 }),
  place('santiago-fine_dining-4', 'santiago', 'fine_dining', 'Santiago de Compostela Bistro', 4.3, 'Santiago de Compostela', '캐주얼 파인 비스트로.', 'Casual fine bistro.', { reviewCount: 700 }),
  place('santiago-fine_dining-5', 'santiago', 'fine_dining', 'Santiago de Compostela Chef\'s Table', 4.4, 'Santiago de Compostela', '셰프 테이블.', 'Chef’s table.', { reviewCount: 390 }),
  place('santiago-bakery-1', 'santiago', 'bakery', 'Santiago de Compostela Bakery', 4.5, 'Santiago de Compostela', '빵·페이스트리.', 'Bread and pastries.', { reviewCount: 900 }),
  place('santiago-bakery-2', 'santiago', 'bakery', 'Santiago de Compostela Patisserie', 4.4, 'Santiago de Compostela', '페이스트리 숍.', 'Pastry shop.', { reviewCount: 720 }),
  place('santiago-bakery-3', 'santiago', 'bakery', 'Santiago de Compostela Bread House', 4.3, 'Santiago de Compostela', '로컬 빵집.', 'Local bakery.', { reviewCount: 580 }),
  place('santiago-bakery-4', 'santiago', 'bakery', 'Café Bakery Santiago de Compostela', 4.3, 'Santiago de Compostela', '베이커리 카페.', 'Bakery café.', { reviewCount: 640 }),
  place('santiago-cafe-1', 'santiago', 'cafe', 'Specialty Coffee Santiago de Compostela', 4.5, 'Santiago de Compostela', '스페셜티 커피.', 'Specialty coffee.', { reviewCount: 1100 }),
  ...
  place('segovia-fine_dining-2', 'segovia', 'fine_dining', 'Segovia Fine Dining 2', 4.4, 'Segovia', '모던 로컬 다이닝.', 'Modern local dining.', { reviewCount: 520 }),
  place('segovia-fine_dining-3', 'segovia', 'fine_dining', 'Segovia Fine Dining 3', 4.3, 'Segovia', '클래식 다이닝.', 'Classic dining.', { reviewCount: 480 }),
  place('segovia-fine_dining-4', 'segovia', 'fine_dining', 'Segovia Bistro', 4.3, 'Segovia', '캐주얼 파인 비스트로.', 'Casual fine bistro.', { reviewCount: 700 }),
  place('segovia-fine_dining-5', 'segovia', 'fine_dining', 'Segovia Chef\'s Table', 4.4, 'Segovia', '셰프 테이블.', 'Chef’s table.', { reviewCount: 390 }),
  place('segovia-bakery-1', 'segovia', 'bakery', 'Segovia Bakery', 4.5, 'Segovia', '빵·페이스트리.', 'Bread and pastries.', { reviewCount: 900 }),
  place('segovia-bakery-2', 'segovia', 'bakery', 'Segovia Patisserie', 4.4, 'Segovia', '페이스트리 숍.', 'Pastry shop.', { reviewCount: 720 }),
  place('segovia-bakery-3', 'segovia', 'bakery', 'Segovia Bread House', 4.3, 'Segovia', '로컬 빵집.', 'Local bakery.', { reviewCount: 580 }),
  place('segovia-bakery-4', 'segovia', 'bakery', 'Café Bakery Segovia', 4.3, 'Segovia', '베이커리 카페.', 'Bakery café.', { reviewCount: 640 }),
  place('segovia-cafe-1', 'segovia', 'cafe', 'Specialty Coffee Segovia', 4.5, 'Segovia', '스페셜티 커피.', 'Specialty coffee.', { reviewCount: 1100 }),
  ...
  place('ronda-fine_dining-2', 'ronda', 'fine_dining', 'Ronda Fine Dining 2', 4.4, 'Ronda', '모던 로컬 다이닝.', 'Modern local dining.', { reviewCount: 520 }),
  place('ronda-fine_dining-3', 'ronda', 'fine_dining', 'Ronda Fine Dining 3', 4.3, 'Ronda', '클래식 다이닝.', 'Classic dining.', { reviewCount: 480 }),
  place('ronda-fine_dining-4', 'ronda', 'fine_dining', 'Ronda Bistro', 4.3, 'Ronda', '캐주얼 파인 비스트로.', 'Casual fine bistro.', { reviewCount: 700 }),
  place('ronda-fine_dining-5', 'ronda', 'fine_dining', 'Ronda Chef\'s Table', 4.4, 'Ronda', '셰프 테이블.', 'Chef’s table.', { reviewCount: 390 }),
  place('ronda-bakery-1', 'ronda', 'bakery', 'Ronda Bakery', 4.5, 'Ronda', '빵·페이스트리.', 'Bread and pastries.', { reviewCount: 900 }),
  place('ronda-bakery-2', 'ronda', 'bakery', 'Ronda Patisserie', 4.4, 'Ronda', '페이스트리 숍.', 'Pastry shop.', { reviewCount: 720 }),
  place('ronda-bakery-3', 'ronda', 'bakery', 'Ronda Bread House', 4.3, 'Ronda', '로컬 빵집.', 'Local bakery.', { reviewCount: 580 }),
  place('ronda-bakery-4', 'ronda', 'bakery', 'Café Bakery Ronda', 4.3, 'Ronda', '베이커리 카페.', 'Bakery café.', { reviewCount: 640 }),
  place('ronda-cafe-1', 'ronda', 'cafe', 'Specialty Coffee Ronda', 4.5, 'Ronda', '스페셜티 커피.', 'Specialty coffee.', { reviewCount: 1100 }),
  ...
  place('girona-fine_dining-2', 'girona', 'fine_dining', 'Girona Fine Dining 2', 4.4, 'Girona', '모던 로컬 다이닝.', 'Modern local dining.', { reviewCount: 520 }),
  place('girona-fine_dining-3', 'girona', 'fine_dining', 'Girona Fine Dining 3', 4.3, 'Girona', '클래식 다이닝.', 'Classic dining.', { reviewCount: 480 }),
  place('girona-fine_dining-4', 'girona', 'fine_dining', 'Girona Bistro', 4.3, 'Girona', '캐주얼 파인 비스트로.', 'Casual fine bistro.', { reviewCount: 700 }),
  place('girona-fine_dining-5', 'girona', 'fine_dining', 'Girona Chef\'s Table', 4.4, 'Girona', '셰프 테이블.', 'Chef’s table.', { reviewCount: 390 }),
  place('girona-bakery-1', 'girona', 'bakery', 'Girona Bakery', 4.5, 'Girona', '빵·페이스트리.', 'Bread and pastries.', { reviewCount: 900 }),
  place('girona-bakery-2', 'girona', 'bakery', 'Girona Patisserie', 4.4, 'Girona', '페이스트리 숍.', 'Pastry shop.', { reviewCount: 720 }),
  place('girona-bakery-3', 'girona', 'bakery', 'Girona Bread House', 4.3, 'Girona', '로컬 빵집.', 'Local bakery.', { reviewCount: 580 }),
  place('girona-bakery-4', 'girona', 'bakery', 'Café Bakery Girona', 4.3, 'Girona', '베이커리 카페.', 'Bakery café.', { reviewCount: 640 }),
  place('girona-cafe-1', 'girona', 'cafe', 'Specialty Coffee Girona', 4.5, 'Girona', '스페셜티 커피.', 'Specialty coffee.', { reviewCount: 1100 }),
