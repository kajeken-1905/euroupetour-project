...
export const placesFIExtra: Place[] = [
  ...
  place('turku-bakery-2', 'turku', 'bakery', 'Leipomo Gryn', 4.8, 'Kauppiaskatu 4, 20100 Turku', '투르쿠의 인기 소규모 베이커리.', 'Popular small bakery in Turku.', { reviewCount: 122 }),
  place('turku-bakery-3', 'turku', 'bakery', 'Kosken Leipomo', 4.5, 'Puutarhakatu 23 B 14, 20100 Turku', '전통 방식의 빵과 페이스트리로 유명한 제과점.', 'Bakery known for traditionally made bread and pastries.', { reviewCount: 528 }),
  place('turku-bakery-4', 'turku', 'bakery', 'Rebelle - Café Bakery Bistro', 4.6, 'Eerikinkatu 7b, 20100 Turku', '브런치와 베이커리를 함께 즐기는 카페 비스트로.', 'Café-bistro serving brunch alongside fresh-baked goods.', { reviewCount: 228 }),
  ...
  place('tampere-bakery-2', 'tampere', 'bakery', 'Boulangerie Marco', 4.6, 'Tullikatu 6, 33100 Tampere', '프랑스식 빵과 페이스트리를 선보이는 베이커리.', 'Bakery serving French-style bread and pastries.', { reviewCount: 442 }),
  place('tampere-bakery-3', 'tampere', 'bakery', 'Konditoria Mari', 4.8, 'Ahotie 34, 33470 Tampere', '탐페레에서 평점이 매우 높은 제과점.', 'Highly rated pastry shop in Tampere.', { reviewCount: 2332 }),
  place('tampere-bakery-4', 'tampere', 'bakery', 'Bakery Café Puusti', 4.6, 'Yliopistonkatu 50, 33100 Tampere', '대학가 인근의 인기 베이커리 카페.', 'Popular bakery café near the university district.', { reviewCount: 402 }),
  ...
  place('tampere-cafe-2', 'tampere', 'cafe', 'Thé Hidden', 4.9, 'Hatanpään valtatie 6B, 33100 Tampere', '탐페레에서 평점이 매우 높은 아늑한 카페.', 'Highly rated, cozy café in Tampere.', { reviewCount: 300 }),
  place('tampere-cafe-3', 'tampere', 'cafe', 'The Waffle Cafe Tampere', 4.5, 'Ojakatu 2, 33100 Tampere', '와플 메뉴로 유명한 인기 카페.', 'Popular café known for its waffle menu.', { reviewCount: 1275 }),
  place('tampere-cafe-4', 'tampere', 'cafe', 'Café Metsonkulma', 4.8, 'Puutarhakatu 20, 33230 Tampere', '높은 평점의 동네 카페.', 'Highly rated neighborhood café.', { reviewCount: 258 }),
  ...
  place('rovaniemi-bakery-2', 'rovaniemi', 'bakery', 'Artesaani Leipä', 4.7, 'Kauppakeskus Rinteenkulma, Koskikatu 25 2krs, 96200 Rovaniemi', '린테엔쿨마 쇼핑몰 내 페이스트리 전문점.', 'Pastry shop inside the Rinteenkulma shopping centre.', { reviewCount: 43 }),
  ...
  place('rovaniemi-cafe-2', 'rovaniemi', 'cafe', 'Coffee House Rovaniemi', 4.4, 'Maakuntakatu 30, 96200 Rovaniemi', '로바니에미 중심가의 인기 카페.', 'Popular café in central Rovaniemi.', { reviewCount: 1073 }),
  place('rovaniemi-cafe-3', 'rovaniemi', 'cafe', 'Cafe & Bar 21', 4.6, 'Rovakatu 21, 96200 Rovaniemi', '높은 평점의 카페 겸 바.', 'Highly rated café and bar.', { reviewCount: 2425 }),
  ...
  place('porvoo-bakery-2', 'porvoo', 'bakery', 'Tarmolan Kotileipomo', 4.3, 'Mestarintie 4, 06150 Porvoo', '전통 방식으로 빵을 굽는 포르보의 가정식 제과점.', "Home-style bakery in Porvoo baking bread the traditional way.", { reviewCount: 126 }),
  place('porvoo-bakery-3', 'porvoo', 'bakery', 'PetriS Chocolate', 4.5, 'Jokikatu 16, 06100 Porvoo', '수제 초콜릿 전문점.', 'Shop specializing in handmade chocolates.', { reviewCount: 224 }),
