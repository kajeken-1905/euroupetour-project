...
export const placesFRExtra: Place[] = [
  ...
  place('avignon-bakery-2', 'avignon', 'bakery', 'la PauZe | Boulangerie Pâtisseries Artisanale', 4.7, '160 Avenue Pierre Semard, 84000 Avignon, France', '아비뇽의 인기 장인 베이커리.', 'Popular artisan bakery in Avignon.', { reviewCount: 189 }),
  place('avignon-bakery-3', 'avignon', 'bakery', 'Les Saveurs des Sillons', 4.7, '5 Boulevard Raspail, 84000 Avignon, France', '라스파유 대로의 인기 베이커리.', 'Popular bakery on Boulevard Raspail.', { reviewCount: 88 }),
  place('avignon-bakery-4', 'avignon', 'bakery', 'The Taste Factory', 4.3, '48 Rue de la Bonneterie, 84000 Avignon, France', '구시가의 베이커리.', 'Bakery in the old town of Avignon.', { reviewCount: 497 }),
  place('avignon-bakery-5', 'avignon', 'bakery', "Boulangerie Saint-Ruf - l'épi d'or", 4.5, '63 Avenue Saint-Ruf, 84000 Avignon, France', '생뤼프 지구의 동네 베이커리.', 'Neighborhood bakery in the Saint-Ruf district.', { reviewCount: 91 }),
  ...
  place('toulouse-bakery-2', 'toulouse', 'bakery', 'Les Frères Chapelier - Boulangerie Bio Artisanale', 4.6, '23 Rue Léon Gambetta, 31000 Toulouse, France', '카피톨 인근의 유기농 장인 베이커리.', 'Organic artisan bakery near Place du Capitole.', { reviewCount: 235 }),
  place('toulouse-bakery-3', 'toulouse', 'bakery', 'Boulangerie Maurice', 4.9, '8 Grande Rue Nazareth, 31000 Toulouse, France', '툴루즈에서 평점이 매우 높은 베이커리.', 'Highly rated bakery in Toulouse.', { reviewCount: 197 }),
  place('toulouse-bakery-4', 'toulouse', 'bakery', 'Boulangerie Pâtisserie Saint Aubin', 4.6, '38 Rue Pierre-Paul Riquet, 31000 Toulouse, France', '생토뱅 지구의 인기 제과점.', 'Popular bakery in the Saint-Aubin district.', { reviewCount: 527 }),
  place('toulouse-bakery-5', 'toulouse', 'bakery', 'Boulangerie Saint Sernin', 4.8, '64 Rue du Taur, 31000 Toulouse, France', '생세르냉 대성당 인근의 인기 베이커리.', 'Popular bakery near the Basilica of Saint-Sernin.', { reviewCount: 161 }),
  ...
  place('montpellier-bakery-2', 'montpellier', 'bakery', 'Des Rêves et du Pain', 4.5, '10 Rue Eugène Lisbonne, 34000 Montpellier, France', '몽펠리에의 인기 베이커리.', 'Popular bakery in Montpellier.', { reviewCount: 892 }),
  place('montpellier-bakery-3', 'montpellier', 'bakery', 'Maison Bonnaire', 4.4, '45 Rue Saint-Guilhem, 34000 Montpellier, France', '생기욤 거리의 인기 제과점.', 'Popular pastry shop on Rue Saint-Guilhem.', { reviewCount: 986 }),
  place('montpellier-bakery-4', 'montpellier', 'bakery', 'Daveloza St Denis', 4.9, '6 Rue du Grand Saint-Jean, 34000 Montpellier, France', '몽펠리에에서 평점이 매우 높은 제과점.', 'Highly rated pastry shop in Montpellier.', { reviewCount: 254 }),
  place('montpellier-bakery-5', 'montpellier', 'bakery', 'Pain Brut', 4.7, '9 Boulevard Victor Hugo, 34000 Montpellier, France', '빅토르 위고 대로의 인기 베이커리.', 'Popular bakery on Boulevard Victor Hugo.', { reviewCount: 366 }),
