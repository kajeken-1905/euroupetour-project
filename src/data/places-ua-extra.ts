...
export const placesUAExtra: Place[] = [
  ...
  place('kyiv-korean-1', 'kyiv', 'korean', 'Korean Kitchen Kyiv 1', 4.6, 'Kyiv', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 980 }),
  place('kyiv-korean-2', 'kyiv', 'korean', 'Kyiv Korean 2', 4.3, 'Kyiv', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 1600 }),
  place('kyiv-korean-3', 'kyiv', 'korean', 'Kyiv Korean 3', 4.3, 'Kyiv', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 320 }),
  ...
  place('lviv-korean-1', 'lviv', 'korean', 'Korean Kitchen Lviv 1', 4.2, 'Lviv', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 720 }),
  place('lviv-korean-2', 'lviv', 'korean', 'Lviv Korean 2', 4.6, 'Lviv', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 1600 }),
  place('lviv-korean-3', 'lviv', 'korean', 'Lviv Korean 3', 4.6, 'Lviv', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 860 }),
  ...
  place('odesa-korean-1', 'odesa', 'korean', 'Korean Kitchen Odesa 1', 4.5, 'Odesa', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 1600 }),
  place('odesa-korean-2', 'odesa', 'korean', 'Odesa Korean 2', 4.5, 'Odesa', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 1400 }),
  place('odesa-korean-3', 'odesa', 'korean', 'Odesa Korean 3', 4.6, 'Odesa', '캐주얼 한식.', 'Casual Korean.', { reviewCount: 560 }),
