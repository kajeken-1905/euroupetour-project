...
export const placesUAExtra: Place[] = [
  ...
  place('kyiv-cafe-2', 'kyiv', 'cafe', 'One Love Coffee', 4.6, 'PinchukArtCentre, 1/3-2 Velyka Vasylkivska St, Kyiv', '핀추크아트센터 6층의 키이우 중심가 파노라마 전망 카페.', 'Café on the 6th floor of the PinchukArtCentre with panoramic views over central Kyiv.'),
  place('kyiv-cafe-3', 'kyiv', 'cafe', 'Kashtan Coffee', 4.6, 'Kyiv, Ukraine', '에스프레소 토닉과 콜드브루, 디저트로 사랑받는 아늑한 커피숍.', 'Cosy coffee shop loved for its espresso tonic, cold brew and sweets.'),
  place('kyiv-cafe-4', 'kyiv', 'cafe', 'Bimbo Coffee & More', 4.6, 'Kyiv, Ukraine', '에스프레소 토닉과 어니언 파이로 유명한 키이우 중심가의 스페셜티 커피숍.', 'Central Kyiv specialty coffee shop known for its espresso tonics and onion pies.'),
