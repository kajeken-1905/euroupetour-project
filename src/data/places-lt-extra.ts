...
export const placesLTExtra: Place[] = [
  ...
  place('kaunas-bakery-3', 'kaunas', 'bakery', 'Habits Bakery', 4.4, 'Gedimino g. 42, Kaunas', '많은 리뷰를 받은 카우나스 중심가의 베이커리.', 'Popular bakery in central Kaunas with a large number of reviews.', { reviewCount: 875 }),
  place('kaunas-bakery-4', 'kaunas', 'bakery', 'LUCCI Bakery', 5.0, 'Muitinės g. 13-3, Kaunas', '만점 평점의 카우나스 베이커리.', 'Perfectly rated bakery in Kaunas.', { reviewCount: 348 }),
  place('kaunas-bakery-5', 'kaunas', 'bakery', 'Bundu', 4.8, 'E. Ožeškienės g. 11, Kaunas', '높은 평점의 카우나스 베이커리.', 'Highly rated bakery in Kaunas.', { reviewCount: 280 }),
  ...
  place('kaunas-cafe-2', 'kaunas', 'cafe', 'NYC Coffee Co.', 4.9, 'Maironio g. 20, Kaunas', '높은 평점의 카우나스 커피숍.', 'Highly rated coffee shop in Kaunas.', { reviewCount: 393 }),
  place('kaunas-cafe-3', 'kaunas', 'cafe', 'Kavalierius', 4.8, 'I. Kanto g. 25, Kaunas', '많은 리뷰를 받은 카우나스 커피숍.', 'Coffee shop in Kaunas with a large number of reviews.', { reviewCount: 638 }),
  place('kaunas-cafe-4', 'kaunas', 'cafe', 'Green Cafe', 4.6, 'Laisvės al. 80, Kaunas', '라이스베스 거리의 인기 카페테리아.', 'Popular cafeteria-style café on Laisvės Alley.', { reviewCount: 1614 }),
  place('kaunas-cafe-5', 'kaunas', 'cafe', 'Trys kartai - coffee and desserts', 4.7, 'S. Daukanto g. 28, Kaunas', '커피와 디저트를 함께 즐길 수 있는 카우나스의 카페.', 'Kaunas café serving coffee alongside desserts.', { reviewCount: 214 }),
  ...
  place('klaipeda-bakery-2', 'klaipeda', 'bakery', 'AZUKERIA', 4.5, 'Turgaus g. 11, Klaipėda', '많은 리뷰를 받은 클라이페다의 제과점.', 'Bakery in Klaipėda with a large number of reviews.', { reviewCount: 245 }),
  place('klaipeda-bakery-3', 'klaipeda', 'bakery', 'Bandelių kepyklėlė', 4.7, 'J. Janonio g. 6, Klaipėda', '높은 평점의 클라이페다 베이커리 카페.', 'Highly rated bakery café in Klaipėda.', { reviewCount: 655 }),
  place('klaipeda-bakery-4', 'klaipeda', 'bakery', 'Gabalėlis torto', 4.9, 'Turgaus a. 16, Klaipėda', '높은 평점의 클라이페다 제과점.', 'Highly rated bakery in Klaipėda.', { reviewCount: 35 }),
  place('klaipeda-bakery-5', 'klaipeda', 'bakery', 'La Farine', 4.8, 'H. Manto g. 23, Klaipėda', '높은 평점의 프랑스식 제과점.', 'Highly rated French-style bakery.', { reviewCount: 18 }),
  ...
  place('klaipeda-cafe-2', 'klaipeda', 'cafe', 'Come Come', 4.6, 'Vėtros g. 8, Klaipėda', '많은 리뷰를 받은 클라이페다의 인기 카페.', 'Popular café in Klaipėda with a large number of reviews.', { reviewCount: 2426 }),
  place('klaipeda-cafe-3', 'klaipeda', 'cafe', 'CAFFEINE LT', 4.6, 'Žvejų g. 1, Klaipėda', '높은 평점의 클라이페다 커피숍.', 'Highly rated coffee shop in Klaipėda.', { reviewCount: 878 }),
  place('klaipeda-cafe-4', 'klaipeda', 'cafe', 'Coffee King', 4.6, 'H. Manto g. 13, Klaipėda', '높은 평점의 클라이페다 커피숍.', 'Highly rated coffee shop in Klaipėda.', { reviewCount: 698 }),
  place('klaipeda-cafe-5', 'klaipeda', 'cafe', 'Musangas', 4.9, 'Liepų g. 64, Klaipėda', '높은 평점의 클라이페다 카페테리아.', 'Highly rated cafeteria-style café in Klaipėda.', { reviewCount: 136 }),
]
