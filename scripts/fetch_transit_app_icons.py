...
APPS: dict[str, tuple[str, str]] = {
    ...
    "metro-porto": ("Metro do Porto", "pt"),
    "metro-madrid": ("Metro de Madrid", "es"),
    "tmb": ("TMB App", "es"),
    "tussam": ("TUSSAM", "es"),
    "metrovalencia": ("Metrovalencia", "es"),
    "gibraltar": ("Visit Gibraltar", "gb"),
    "sncf": ("SNCF Connect", "fr"),
    "idfm": ("Île-de-France Mobilités", "fr"),
    "tfl": ("TfL Go", "gb"),
    "irish-rail": ("Irish Rail", "ie"),
    "sncb": ("SNCB", "be"),
    "ns": ("NS Reisplanner", "nl"),
    "cfl": ("CFL Mobile", "lu"),
    "db": ("DB Navigator", "de"),
    "sbb": ("SBB Mobile", "ch"),
    "oebb": ("ÖBB", "at"),
...
COLORS = {
    ...
    "bolt": ("#34D186", "#14110F"),
    "flixbus": ("#73D700", "#14110F"),
    "trainline": ("#1C57C4", "#FFFFFF"),
    "renfe": ("#8B1A1A", "#FFFFFF"),
    "alsa": ("#0B6E4F", "#FFFFFF"),
    "cp": ("#0A4D8C", "#FFFFFF"),
